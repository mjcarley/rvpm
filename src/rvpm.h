...
gint rvpm_tree_update(rvpm_tree_t *t, gint nthreads, gdouble *work) ;
...
gint rvpm_solver_solve(rvpm_tree_t *t, rvpm_solver_t *s,
		       gdouble dt, gdouble *u, gint ustr,
		       gdouble *work) ;
...
gint rvpm_tree_update_f(rvpm_tree_t *t, gint nthreads, gfloat *work) ;
...
gint rvpm_solver_solve_f(rvpm_tree_t *t, rvpm_solver_t *s,
			 gfloat dt, gfloat *u, gint ustr,
			 gfloat *work) ;
